  ...
  return (
    <>
      ...
      <AIChatSidePanel
        ...
        onInsertCode={(code, fileName, position) => handleInsertCode(code, fileName, position)}
        onRunCode={(code, language) => handleRunCode(code, language)}
        activeFileName={activeFile?.name}
        activeFileContent={activeFile?.content}
        activeFileLanguage={activeFile?.content?.includes("</") ? "html" : "typescript"}
